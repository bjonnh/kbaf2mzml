...
gcc -O3 -march=native baf2sql_adapter/src/main/c/baf2sql_adapter.c -I"${LINUX_JVM}"/include -I"${LINUX_JVM}"/include/linux -shared -o lib/libbaf2sql_adapter.so -Llib -lbaf2sql_c
